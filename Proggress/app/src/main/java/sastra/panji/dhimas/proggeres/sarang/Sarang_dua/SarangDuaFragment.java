...
public class SarangDuaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_sarang_dua, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        circularProgressBar = view.findViewById(R.id.circularBerat2);
        chart = view.findViewById(R.id.fragment_sarang_dua_chart);
        panen = view.findViewById(R.id.btn_panen2);
    ...
    private void line() {
        ...
        cartesian.title("Berat Sarang 2");

        cartesian.yAxis(0).title("Nilai Berat Sarang 2");
