...
public class Kelembapan_Mingguan extends AppCompatActivity {
    ...
    final Runnable r = new Runnable() {
        public void run() {
            ...
            dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'H:mm");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelembapan__mingguan);
        donutProgress = findViewById(R.id.donut_kelembapan_mingguan);
        loading = findViewById(R.id.kelembapan_loading_minguan);

        cartesian = AnyChart.line();
        url = Preferences.getUrlActive(getBaseContext());
        donutProgress.setMax(100);
        chart = findViewById(R.id.any_chart_view_kelembapan_mingguan);
        calendar = Calendar.getInstance();
        dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'H:mm");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (array.length() != 0) {
                        ...
                        Toasty.info(Kelembapan_Mingguan.this, "Data Kosong", Toasty.LENGTH_SHORT, true).show();
