...
public class Suhu_Bulanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suhu_bulanan);

        chart = findViewById(R.id.any_chart_view_bulanan);
        loading = findViewById(R.id.suhu_loading_bulanan);
        donutProgress = findViewById(R.id.donut_progress_bulanan);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (array.length() != 0) {
                        ...
                        Toasty.info(Suhu_Bulanan.this, "Data Kosong", Toasty.LENGTH_SHORT, true).show();
                    }
