...
public class Suhu extends AppCompatActivity {
    ...
    final Runnable r = new Runnable() {
        public void run() {
            ...
            suhunya(url + "&start=" + date + "&end=" + now);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minggu = findViewById(R.id.btn_grafik_mingguan);
        bulan = findViewById(R.id.btn_grafik_bulan);
        loading = findViewById(R.id.suhu_loading);
        donutProgress = findViewById(R.id.donut_progress);
        donutProgress.setMax(50);
        url = Preferences.getUrlActive(getBaseContext());
        chart = findViewById(R.id.any_chart_view_suhu);
        ...
        minggu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Suhu.this, Suhu_Mingguan.class);
                startActivity(i);
                onPause();
            }
        });
        bulan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Suhu.this, Suhu_Bulanan.class);
                startActivity(i);
                onPause();
            }
        });
    ...
    public void suhunya(String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url + "&timezone=Asia/Jakarta", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String nilai = "";
                    if (array.length() == 0) {
                        Toasty.info(Suhu.this, "Data Kosong", Toasty.LENGTH_SHORT, true).show();
                    } else {
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            seriesData.add(new Suhu.CustomDataEntry(getDate(date), Float.valueOf(nilai2), Float.valueOf(nilai)));
    ...
    public void line() {
        ...
        List<DataEntry> seriesData = new ArrayList<>();
        seriesData.add(new Suhu.CustomDataEntry("No Data", 0, 0));
        set = Set.instantiate();
        set.data(seriesData);
